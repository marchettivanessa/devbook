...
func BuscarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	//transforma o parametro de string pra uint - como declarado no struct
...
func AtualizarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	//nil é para quando não queremos retornar nada
...
func DeletarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	if usuarioID != usuarioIDNoToken {
		respostas.Erro(w, http.StatusForbidden, errors.New("Não é possível deletar um usuárui que não seja o seu."))
	}
